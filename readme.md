# FluentWidgetsPlugin Build & Extension Guide
...
Build your application - should work the same as before.
...
This structure makes it **super easy** to keep adding widgets to your FluentWidgetsPlugin! 🚀